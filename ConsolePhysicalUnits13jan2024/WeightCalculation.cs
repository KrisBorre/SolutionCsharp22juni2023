...
{
    internal static class WeightCalculation
    {
        internal static int ConvertTonIntoKilogram(double weight)
        {
            return Convert.ToInt32(weight * 1000);
        }

        internal static double ConvertKilogramIntoTon(int weight)
        {
